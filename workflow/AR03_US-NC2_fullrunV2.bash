...
ncap2 -O -s 'nstem(1)=0.01491' ctsm60_params.c240208_${RUNXX}_${SITE}_postthinning.nc ctsm60_params.c240208_${RUNXX}_${SITE}_postthinning.nc
...
ncap2 -O -s 'PCT_NAT_PFT(1,:,:)= 66.' /home/duarteh/Dropbox/UNH/CLM/surfdata/${SITE}/MOD-${RUNXX}_surfdata_${SITE}_hist_1850_78pfts_c240617.nc /home/duarteh/Dropbox/UNH/CLM/surfdata/${SITE}/MOD-${RUNXX}_surfdata_${SITE}_hist_1850_78pfts_c240617.nc
...
ncap2 -O -s 'PCT_NAT_PFT(14,:,:)= 34.' /home/duarteh/Dropbox/UNH/CLM/surfdata/${SITE}/MOD-${RUNXX}_surfdata_${SITE}_hist_1850_78pfts_c240617.nc /home/duarteh/Dropbox/UNH/CLM/surfdata/${SITE}/MOD-${RUNXX}_surfdata_${SITE}_hist_1850_78pfts_c240617.nc
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
ncap2 -O -s 'PCT_NAT_PFT(:,1,:,:)=66.0'                           MOD-${RUNXX}_landuse.timeseries_${SITE}_SSP2-4.5_1850-2100_78pfts_c240617.nc MOD-${RUNXX}_landuse.timeseries_${SITE}_SSP2-4.5_1850-2100_78pfts_c240617.nc
...
ncap2 -O -s 'PCT_NAT_PFT_MAX(1,:,:)=66.0'                         MOD-${RUNXX}_landuse.timeseries_${SITE}_SSP2-4.5_1850-2100_78pfts_c240617.nc MOD-${RUNXX}_landuse.timeseries_${SITE}_SSP2-4.5_1850-2100_78pfts_c240617.nc
