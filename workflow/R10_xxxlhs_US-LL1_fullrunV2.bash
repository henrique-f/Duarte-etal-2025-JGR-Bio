...
#gC/gN
ncap2 -O -s 'leafcn(1)=43.42' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#gC/gN
ncap2 -O -s 'lflitcn(1)=96.49' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#gC/gN
ncap2 -O -s 'frootcn(1)=30.71' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#gC/gC
ncap2 -O -s 'froot_leaf(1)=1.49' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc
ncap2 -O -s 'froot_leaf(14)=0.9' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#gC/gC
ncap2 -O -s 'stem_leaf(1)=2.2' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#gC/gC
ncap2 -O -s 'croot_stem(1)=0.29' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#yr
ncap2 -O -s 'leaf_long(1)=2.67' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#m2/gC
ncap2 -O -s 'slatop(1)=0.00571' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#kPa**0.5
ncap2 -O -s 'medlynslope(1)=3.096' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#umol/m2/s
ncap2 -O -s 'medlynintercept(1)=22550.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc
ncap2 -O -s 'medlynintercept(14)=48500.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#kg/m3
ncap2 -O -s 'wood_density(1)=540.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#trees/m2
ncap2 -O -s 'nstem(1)=0.0355' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#gC/gC
ncap2 -O -s 'flivewd(1)=0.071' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#adim
ncap2 -O -s 'q10_hr=1.5' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc
ncap2 -O -s 'q10_mr=1.5' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#J/mol
ncap2 -O -s 'vcmaxha=72000.*1.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc
ncap2 -O -s 'jmaxha=50000.*1.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc
ncap2 -O -s 'tpuha=72000.*1.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc
ncap2 -O -s 'lmrha=46390.*1.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#New
ncap2 -O -s 'kmax(:,1)=kmax(:,1)*1.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#New (kg/m2)
ncap2 -O -s 'liq_canopy_storage_scalar=0.1' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc
...
ncap2 -O -s 'PCT_NAT_PFT(1,:,:)= 66.' /home/duarteh/Dropbox/UNH/CLM/surfdata/${SITE}/MOD-${RUNXX}_surfdata_${SITE}_hist_1850_78pfts_c240731.nc /home/duarteh/Dropbox/UNH/CLM/surfdata/${SITE}/MOD-${RUNXX}_surfdata_${SITE}_hist_1850_78pfts_c240731.nc
...
ncap2 -O -s 'PCT_NAT_PFT(14,:,:)= 34.' /home/duarteh/Dropbox/UNH/CLM/surfdata/${SITE}/MOD-${RUNXX}_surfdata_${SITE}_hist_1850_78pfts_c240731.nc /home/duarteh/Dropbox/UNH/CLM/surfdata/${SITE}/MOD-${RUNXX}_surfdata_${SITE}_hist_1850_78pfts_c240731.nc
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
ncap2 -O -s 'PCT_NAT_PFT(:,1,:,:)=66.0'                           MOD-${RUNXX}_landuse.timeseries_${SITE}_SSP2-4.5_1850-2100_78pfts_c240731.nc MOD-${RUNXX}_landuse.timeseries_${SITE}_SSP2-4.5_1850-2100_78pfts_c240731.nc
...
ncap2 -O -s 'PCT_NAT_PFT(:,14,:,:)=34.0'                          MOD-${RUNXX}_landuse.timeseries_${SITE}_SSP2-4.5_1850-2100_78pfts_c240731.nc MOD-${RUNXX}_landuse.timeseries_${SITE}_SSP2-4.5_1850-2100_78pfts_c240731.nc
...
ncap2 -O -s 'PCT_NAT_PFT_MAX(1,:,:)=66.0'                         MOD-${RUNXX}_landuse.timeseries_${SITE}_SSP2-4.5_1850-2100_78pfts_c240731.nc MOD-${RUNXX}_landuse.timeseries_${SITE}_SSP2-4.5_1850-2100_78pfts_c240731.nc
...
ncap2 -O -s 'PCT_NAT_PFT_MAX(14,:,:)=34.0'                        MOD-${RUNXX}_landuse.timeseries_${SITE}_SSP2-4.5_1850-2100_78pfts_c240731.nc MOD-${RUNXX}_landuse.timeseries_${SITE}_SSP2-4.5_1850-2100_78pfts_c240731.nc
...
#NEW: will reuse executable from base case, so we don't need to compile for all LHS instances...
cp /media/duarteh/seagate8tb_a/clm-projects/scratch/R10_US-LL1_tr2of4/R10_US-LL1_tr2of4/bld/cesm.exe /media/duarteh/seagate8tb_a/clm-projects/scratch/${NOMECASO}/${NOMECASO}/bld
./xmlchange BUILD_COMPLETE=TRUE #NEW: this is to bypass the internal check, otherwise we'd be forced to compile the model

#NEW: this is unnecessary, as I am using a precompiled executable
...
#sed -i -e 's/real(r8), parameter :: SNC = 0.004_r8/real(r8), parameter :: SNC = 0.00076_r8/g' /media/duarteh/seagate8tb_a/clm-projects/scratch/${NOMECASO}/SourceMods/src.clm/LunaMod.F90
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
#NEW: FINIDAT HARDCODED TO R10 BASELINE
echo "finidat = '/media/duarteh/seagate8tb_a/clm-projects/scratch/R10_US-LL1_tr1of4/R10_US-LL1_tr1of4/run/R10_US-LL1_tr1of4.clm2.r.1918-01-01-00000.nc'" >> user_nl_clm
...
#NEW: will reuse executable from base case, so we don't need to compile for all LHS instances...
cp /media/duarteh/seagate8tb_a/clm-projects/scratch/R10_US-LL1_tr3of4/R10_US-LL1_tr3of4/bld/cesm.exe /media/duarteh/seagate8tb_a/clm-projects/scratch/${NOMECASO}/${NOMECASO}/bld
./xmlchange BUILD_COMPLETE=TRUE #NEW: this is to bypass the internal check, otherwise we'd be forced to compile the model

#NEW: now using precompiled executable
#vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv SOURCE MODS vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
#cp /media/duarteh/seagate8tb_a/clm-master/src/biogeophys/LunaMod.F90 /media/duarteh/seagate8tb_a/clm-projects/scratch/${NOMECASO}/SourceMods/src.clm/
#sed -i -e 's/real(r8), parameter :: SNC = 0.004_r8/real(r8), parameter :: SNC = 0.00076_r8/g' /media/duarteh/seagate8tb_a/clm-projects/scratch/${NOMECASO}/SourceMods/src.clm/LunaMod.F90
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
echo "hist_fincl3 = 'GPP','TLAI','ER','Qle','Qh','Qstor','Rnet','FCEV', 'FCTR', 'FGEV', 'TV', 'TSKIN', 'TOTSOMC', 'TOTSOMN', 'BTRANMN' ,'SMINN', 'NPP', 'QVEGE', 'QVEGT', 'QSOIL', 'QFLX_EVAP_TOT'" >> user_nl_clm
...
#NEW: now using pre-compiled executable
#./case.build
./case.submit
...
#NEW: will reuse executable from base case, so we don't need to compile for all LHS instances...
cp /media/duarteh/seagate8tb_a/clm-projects/scratch/R10_US-LL1_tr4of4/R10_US-LL1_tr4of4/bld/cesm.exe /media/duarteh/seagate8tb_a/clm-projects/scratch/${NOMECASO}/${NOMECASO}/bld
./xmlchange BUILD_COMPLETE=TRUE #NEW: this is to bypass the internal check, otherwise we'd be forced to compile the model
