...
#
#ncap2 -O -s 'medlynintercept(1)=20000.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc
...
ncap2 -O -s 'nstem(1)=(1.-0.58)*0.08' ctsm60_params.c240208_${RUNXX}_${SITE}_postthinning.nc ctsm60_params.c240208_${RUNXX}_${SITE}_postthinning.nc
