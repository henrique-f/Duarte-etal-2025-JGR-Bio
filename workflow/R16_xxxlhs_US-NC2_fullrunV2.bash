...
#Sun Jul 27 06:22:38 AM EDT 2025: script taylored for a LHS approach, starting at tr2, initializing from a base case/tr1, using precompiled executable


export RUNXX="R16_xxxlhs"
export SITE="US-NC2"
...
cp /media/duarteh/seagate8tb_a/clm-projects/scratch/R16_US-NC2_tr2of4/R16_US-NC2_tr2of4/bld/cesm.exe /media/duarteh/seagate8tb_a/clm-projects/scratch/${NOMECASO}/${NOMECASO}/bld
...
#NEW: WATCH OUT: I am initializing the tr2 run with the base case (R16)!
echo "finidat = '/media/duarteh/seagate8tb_a/clm-projects/scratch/R16_US-NC2_tr1of4/R16_US-NC2_tr1of4/run/R16_US-NC2_tr1of4.clm2.r.1992-01-01-00000.nc'" >> user_nl_clm
...
#New: I am using a pre-compiled executable now
#./case.build
./case.submit
...
#NEW: will reuse executable from base case, so we don't need to compile for all LHS instances...
cp /media/duarteh/seagate8tb_a/clm-projects/scratch/R16_US-NC2_tr3of4/R16_US-NC2_tr3of4/bld/cesm.exe /media/duarteh/seagate8tb_a/clm-projects/scratch/${NOMECASO}/${NOMECASO}/bld
./xmlchange BUILD_COMPLETE=TRUE #NEW: this is to bypass the internal check, otherwise we'd be forced to compile the model
...
#echo "hist_nhtfrq = 1" >> user_nl_clm
echo "hist_fincl1 = 'TOTECOSYSC', 'TOTECOSYSN', 'TOTSOMC', 'TOTSOMN', 'TOTVEGC','TOTVEGN', 'TLAI', 'GPP', 'CPOOL', 'NPP', 'TWS', 'H2OSOI', 'TOTFIRE', 'DEADSTEMC', 'LIVESTEMC', 'LEAFC', 'DEADCROOTC', 'LIVECROOTC', 'FROOTC', 'WOODC', 'TOT_WOODPRODC', 'WOOD_HARVESTC', 'HTOP', 'TOTLITC', 'CWD_C', 'Qh', 'Qle', 'Qstor', 'Rnet', 'ER', 'TV'" >> user_nl_clm
echo "hist_fincl2 = 'RAIN', 'SNOW', 'TBOT', 'RH', 'VPD', 'PBOT', 'LWup', 'LWdown', 'SWup', 'SWdown', 'WIND', 'MR', 'GR', 'HR', 'GPP', 'TLAI', 'Qh', 'Qle', 'Qstor', 'Rnet', 'TV', 'TSKIN', 'FCEV', 'FCTR', 'FGEV', 'BTRANMN', 'SOILWATER_10CM', 'TWS', 'ZWT', 'H2OSOI', 'WF', 'watsat', 'watfc', 'FSDS', 'FLDS', 'ZBOT', 'ER', 'AR', 'NPP', 'NEP', 'NEE', 'TOTFIRE', 'EFLX_LH_TOT', 'FSH', 'FSH_TO_COUPLER', 'QRUNOFF', 'QH2OSFC', 'QOVER', 'QDRAI', 'QDRAI_PERCH', 'QDRAI_XS', 'QFLOOD', 'QVEGE', 'QVEGT', 'QSOIL', 'ERRH2O', 'QFLX_EVAP_TOT'" >> user_nl_clm
...
#NEW: will reuse executable from base case, so we don't need to compile for all LHS instances...
cp /media/duarteh/seagate8tb_a/clm-projects/scratch/R16_US-NC2_tr3bof4/R16_US-NC2_tr3bof4/bld/cesm.exe /media/duarteh/seagate8tb_a/clm-projects/scratch/${NOMECASO}/${NOMECASO}/bld
./xmlchange BUILD_COMPLETE=TRUE #NEW: this is to bypass the internal check, otherwise we'd be forced to compile the model
...
#NEW: will reuse executable from base case, so we don't need to compile for all LHS instances...
cp /media/duarteh/seagate8tb_a/clm-projects/scratch/R16_US-NC2_tr4of4/R16_US-NC2_tr4of4/bld/cesm.exe /media/duarteh/seagate8tb_a/clm-projects/scratch/${NOMECASO}/${NOMECASO}/bld
./xmlchange BUILD_COMPLETE=TRUE #NEW: this is to bypass the internal check, otherwise we'd be forced to compile the model
