...
#J/mol
ncap2 -O -s 'vcmaxha=72000.*2.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc
ncap2 -O -s 'jmaxha=50000.*2.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc
ncap2 -O -s 'tpuha=72000.*2.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc
ncap2 -O -s 'lmrha=46390.*1.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc

#New
ncap2 -O -s 'kmax(:,1)=kmax(:,1)*0.7' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc
