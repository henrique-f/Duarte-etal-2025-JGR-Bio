...
#umol/m2/s
#ncap2 -O -s 'medlynintercept(1)=50000.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc
#ncap2 -O -s 'medlynintercept(14)=50000.' ctsm60_params.c240208_${RUNXX}_${SITE}.nc ctsm60_params.c240208_${RUNXX}_${SITE}.nc
...
#echo "hist_nhtfrq = 1" >> user_nl_clm
echo "hist_fincl1 = 'TOTECOSYSC', 'TOTECOSYSN', 'TOTSOMC', 'TOTSOMN', 'TOTVEGC','TOTVEGN', 'TLAI', 'GPP', 'CPOOL', 'NPP', 'TWS', 'H2OSOI', 'TOTFIRE', 'DEADSTEMC', 'LIVESTEMC', 'LEAFC', 'DEADCROOTC', 'LIVECROOTC', 'FROOTC', 'WOODC', 'TOT_WOODPRODC', 'WOOD_HARVESTC', 'HTOP', 'TOTLITC', 'CWD_C', 'Qh', 'Qle', 'Qstor', 'Rnet', 'ER', 'TV', 'BTRANMN', 'SMINN'" >> user_nl_clm
echo "hist_fincl2 = 'RAIN', 'SNOW', 'TBOT', 'RH', 'VPD', 'PBOT', 'LWup', 'LWdown', 'SWup', 'SWdown', 'WIND', 'MR', 'GR', 'HR', 'GPP', 'TLAI', 'Qh', 'Qle', 'Qstor', 'Rnet', 'TV', 'TSKIN', 'FCEV', 'FCTR', 'FGEV', 'BTRANMN', 'SOILWATER_10CM', 'TWS', 'ZWT', 'H2OSOI', 'WF', 'watsat', 'watfc', 'FSDS', 'FLDS', 'ZBOT', 'ER', 'AR', 'NPP', 'NEP', 'NEE', 'TOTFIRE', 'EFLX_LH_TOT', 'FSH', 'FSH_TO_COUPLER', 'QRUNOFF', 'QH2OSFC', 'QOVER', 'QDRAI', 'QDRAI_PERCH', 'QDRAI_XS', 'QFLOOD', 'SMINN'" >> user_nl_clm
